...
if __name__ == "__main__":
    ...
    for process_number, process_cmds in process_number_to_cmds.items():
        with open(
            "scripts/eval_search_conj_normal_order_{}_use_proof_{}_use_state_first_{}_search_width_{}_maximum_queue_length_{}_temperature_{}_max_tokens_{}_max_trials_{}_timeout_{}_{}.sh".format(
                use_conj,
                use_proof,
                use_state_first,
                search_width,
