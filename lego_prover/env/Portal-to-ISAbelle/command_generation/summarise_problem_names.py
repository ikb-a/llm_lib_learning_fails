...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Summarise the names and files from extractions."
    )
    parser.add_argument(
        "--extraction-path", "-ep", help="The path to extraction files."
    )
            ...
            if "ground_truth" in entry_path:
                ...
                for theorem_name in problem_names:
                    ...
                    json.dump(
                        ...
                        open(os.path.join(dump_path, f"test_name_{total}.json"), "w"),
                    )
