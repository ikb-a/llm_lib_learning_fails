...
def run_proof_example(env, steps, tls_name="default"):
    ...
    for i, step in enumerate(steps):
        ...
        obs, reward, done, metadata = env.step_to_top_level_state(
            action=step, tls_name=tls_name, new_name=tls_name
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--working-dir",
        default="/private/home/aqj/afp-2021-10-22/thys/FunWithFunctions",
    )
    parser.add_argument(
        "--theory-file",
        default="/private/home/aqj/afp-2021-10-22/thys/FunWithFunctions/FunWithFunctions.thy",
    )
