...
if __name__ == "__main__":
    ...
    afp_path = input(
        "Path to the working directory (default /home/qj213/Isabelle2021/src/HOL/Examples): "
    )
    afp_path = (
        "/home/qj213/Isabelle2021/src/HOL/Examples"
        if not afp_path
        else afp_path.strip()
    )
    file_path = input(
        "Path to a theory file (default /home/qj213/Isabelle2021/src/HOL/Examples/Drinker.thy): "
    )
    file_path = (
        "/home/qj213/Isabelle2021/src/HOL/Examples/Drinker.thy"
        if not file_path
