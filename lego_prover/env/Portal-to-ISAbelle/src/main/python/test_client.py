...
if __name__ == "__main__":
    ...
    print(
        env.step_to_top_level_state(
            "normalhammer <del>primes_infinite<del>", "test", "test2"
        )
    )
    print(
        env.step_to_top_level_state(
            "normalhammer <del>primes_infinite,bigger_prime<del>", "test", "test3"
        )
    )
    print(
        env.step_to_top_level_state(
            "normalhammer <add>next_prime_bound<add> <del>primes_infinite,bigger_prime<del>",
            "test",
            "test4",
        )
    )
