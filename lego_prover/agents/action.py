...
class ActionAgent:
    def __init__(
        ...
        request_timeout=120,
        ckpt_dir="ckpt",
        max_calls_per_s=None,
        decomposer_filename=None,
        formalizer_filename=None,
        model_tokenizer_name=None,
    ):
        self.logger = logger
        ...
        self.llm = LLMMixture(
            ...
            logger=self.logger,
            usage_log=(ckpt_dir, 'usage_prover',),
        ...
        self.formalizer_filename = (
            formalizer_filename if formalizer_filename is not None else "formalizer"
        )

        self.decomposer_filename = (
            decomposer_filename if decomposer_filename is not None else "decomposer"
        )
...
"""
    ...
    def decomposer(self, context):
        system_prompt_template = load_prompt(self.decomposer_filename)
    ...
    def render_formalizer_system_message(self):
        system_template = load_prompt(self.formalizer_filename)
