...
def json_dump(data, *file_path, **kwargs):
    ...
    # Save file, then replace using an atomic replace command.
    # Should prevent total data loss due to job terminating during write.
...
# def load_json_list(*file_path, **kwargs):
#     """
#     Wrapper for load_json that returns an empty list if json fails to decode
#     the file (e.g., if the file is emtpy)
#     """
#     try:
#         return json_load(*file_path, **kwargs)
#     except json.decoder.JSONDecodeError:
#         return []

# For the time being, don't use the above. Problem causing an empty
# file should hopefully now be fixed?
load_json_list = json_load
