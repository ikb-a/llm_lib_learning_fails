...
This script is for Experiment 2 (i.e., prompt stability)
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "dataset",
        choices=["test12", "val12"],
        help="Whether the 5% random subset of the test or validation split used in this experiment.",
    )
    parser.add_argument(
        "prompt",
        choices=["baseline", "paraphrase"],
        help="Whether the baseline or paraphrased prompt was used in this experiment",
    )
    parser.add_argument(
        "filepath",
        type=str,
    ...
    for filename in filenames:
        ...
        for line in data:
            if "True" in line:
                ...
                print(f"lp,{args.dataset},{args.prompt},{run},{attempt},{problem}")
